import svgPaths from "./svg-6u1cy8slxr";
import imgGeminiGeneratedImageHylgx1Hylgx1Hylg1 from "./be86d5a7c73feb2b24a54bab9f7253afbfc7dab1.png";
import imgGeminiGeneratedImageDx8556Dx8556Dx851 from "./cabc8d1e5713d81c9f3ae07b23d35bb528ae06e3.png";

function Frame12() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="location">
        <div className="absolute inset-[8.33%_20.83%_8.34%_20.83%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.33333 13.3328">
            <path d={svgPaths.p2888df80} fill="var(--fill-0, #F8F8F7)" id="Vector" />
          </svg>
        </div>
      </div>
...
function Frame4() {
  return (
    <div className="-translate-x-1/2 absolute bottom-0 content-stretch flex h-[126px] items-start justify-between left-1/2 pb-[8px] w-[1760px]">
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-solid border-t inset-0 pointer-events-none" />
      <div className="relative rounded-[6px] self-stretch shrink-0 w-[258px]" data-name="Detail">
      ...
      <div className="relative rounded-[6px] self-stretch shrink-0 w-[279px]" data-name="Detail">
        <div className="content-stretch flex flex-col gap-[16px] items-start py-[24px] relative size-full">
          <Frame28 />
        </div>
      </div>
...
function Component2HeroSection() {
  return (
    <div className="h-[1000px] relative shrink-0 w-[1920px]" data-name="2_hero-section">
      <div className="absolute h-[1025px] left-0 top-0 w-[1920px]" data-name="Gemini_Generated_Image_hylgx1hylgx1hylg 1">
        <img alt="" className="absolute inset-0 max-w-none object-bottom pointer-events-none size-full" src={imgGeminiGeneratedImageHylgx1Hylgx1Hylg1.src} />
      </div>
      <Frame3 />
      <Frame4 />
    </div>
...
function Component3OQueInvestiga() {
  return (
    <div className="bg-[#1e0c01] content-stretch flex gap-[96px] h-[626px] items-center overflow-clip px-[80px] py-[160px] relative shrink-0 w-[1920px]" data-name="3_o-que-investiga">
      <Frame73 />
      <Frame74 />
    </div>
  );
...
function Frame10() {
  return (
    <div className="content-center flex flex-wrap gap-[24px] items-center relative shrink-0 w-full">
      <div className="bg-[#f8f8f7] drop-shadow-[1px_3px_0px_#39261b] flex-[1_0_0] min-w-px relative rounded-[6px]" data-name="Detail">
...
function Component4ParaQuemEIndicado() {
  return (
    <div className="bg-[#f8f8f7] content-stretch flex flex-col gap-[112px] items-start overflow-clip pb-[184px] pt-[80px] px-[80px] relative shrink-0 w-[1920px]" data-name="4_para-quem-e-indicado">
      <Frame75 />
      <Frame10 />
    </div>
  );
...
function Frame18() {
  return (
    <div className="content-center flex flex-wrap gap-[24px] h-[202px] items-center relative shrink-0 w-full">
      <div className="flex-[1_0_0] h-[202px] min-w-px relative rounded-[6px]" data-name="Detail">
        <div aria-hidden="true" className="absolute border border-[#dedcdc] border-solid inset-0 pointer-events-none rounded-[6px]" />
        <div className="content-stretch flex flex-col gap-[16px] items-start p-[24px] relative size-full">
          <Frame32 />
        </div>
      </div>
...
function Frame16() {
  return (
    <div className="content-stretch flex flex-col gap-[112px] items-start relative shrink-0 w-[1760px]">
      <Frame17 />
      <Frame18 />
    </div>
  );
...
function Component5SobreAAvaliacao() {
  return (
    <div className="bg-[#1e0c01] content-stretch flex flex-col items-start overflow-clip pb-[184px] pt-[80px] px-[80px] relative shrink-0 w-[1920px]" data-name="5_sobre-a-avaliacao">
      <Frame16 />
    </div>
  );
}
...
function Frame25() {
  return (
    <div className="bg-[#f8f8f7] drop-shadow-[1px_3px_0px_#39261b] relative rounded-[4px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border border-[#39261b] border-solid inset-0 pointer-events-none rounded-[4px]" />
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-[652px]">
      <Frame83 />
    </div>
  );
}

function Component6QuemVaiTeAtender() {
  return (
    <div className="bg-[#f8f8f7] content-stretch flex flex-col gap-[96px] h-[839px] items-start overflow-clip p-[80px] relative shrink-0 w-[1920px]" data-name="6_quem-vai-te-atender">
      <Frame23 />
      <Frame24 />
      <div className="absolute flex h-[1256px] items-center justify-center right-[-53px] top-[-260px] w-[1145px]">
        <div className="-scale-y-100 flex-none rotate-180">
          <div className="h-[1256px] relative w-[1145px]" data-name="Gemini_Generated_Image_dx8556dx8556dx85 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgGeminiGeneratedImageDx8556Dx8556Dx851.src} />
          </div>
        </div>
      </div>
    </div>
...
function Frame37() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-center relative shrink-0 w-[832px]">
      <Frame38 />
      <Frame41 />
    </div>
  );
...
function Component7TesteGratuito() {
  return (
    <div className="bg-[#1e0c01] content-stretch flex flex-col items-center justify-center overflow-clip pb-[104px] pt-[80px] px-[80px] relative shrink-0 w-[1920px]" data-name="7_teste-gratuito">
      <Frame37 />
    </div>
  );
}
...
function Frame42() {
  return (
    <div className="content-stretch flex flex-col gap-[64px] items-center relative shrink-0 w-[832px]">
      <Frame43 />
      <Frame44 />
    </div>
  );
...
function Component8Faq() {
  return (
    <div className="bg-[#f8f8f7] relative shrink-0 w-[1920px]" data-name="8_faq">
      <div className="content-stretch flex items-center justify-center overflow-clip pb-[104px] pt-[80px] px-[592px] relative rounded-[inherit] size-full">
        <Frame42 />
      </div>
      <div aria-hidden="true" className="absolute border-[#c9c6c5] border-b border-solid inset-0 pointer-events-none" />
    </div>
  );
}
...
function Frame60() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <div className="bg-[#39261b] content-stretch flex gap-[10px] items-center justify-center p-[10px] relative rounded-[64px] shrink-0 size-[32px]" data-name="Indice">
        <div className="overflow-clip relative shrink-0 size-[22px]" data-name="location">
          <div className="absolute inset-[8.33%_20.83%_8.34%_20.83%]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.8333 18.3326">
              <path d={svgPaths.p37e7fd80} fill="var(--fill-0, #F8F8F7)" id="Vector" />
            </svg>
          </div>
        </div>
      </div>
...
function Frame62() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <div className="relative rounded-[38px] shrink-0 w-full" data-name="Button">
...
function Frame63() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <div className="bg-[#39261b] content-stretch flex gap-[10px] items-center justify-center p-[10px] relative rounded-[64px] shrink-0 size-[32px]" data-name="Indice">
        <div className="overflow-clip relative shrink-0 size-[22px]" data-name="time">
          <div className="absolute inset-[12.5%]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.5 16.5">
              <path d={svgPaths.p29677200} fill="var(--fill-0, #F8F8F7)" id="Vector" />
            </svg>
          </div>
        </div>
      </div>
...
function Frame65() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <div className="bg-[#39261b] content-stretch flex gap-[10px] items-center justify-center p-[10px] relative rounded-[64px] shrink-0 size-[32px]" data-name="Indice">
        <div className="overflow-clip relative shrink-0 size-[22px]" data-name="call-center">
          <div className="-translate-x-1/2 absolute aspect-[18/18] bottom-[16.67%] left-1/2 top-[16.67%]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.6667 14.6667">
              <path d={svgPaths.p1d26fb00} fill="var(--fill-0, #F8F8F7)" id="Vector" />
            </svg>
          </div>
        </div>
      </div>
...
function Frame59() {
  return (
    <div className="content-stretch flex gap-[24px] h-[286px] items-start relative shrink-0 w-[1760px]">
      <div className="flex-[1_0_0] min-w-px relative rounded-[6px] self-stretch" data-name="Detail">
        <div aria-hidden="true" className="absolute border border-[#39261b] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function Component9Contato() {
  return (
    <div className="bg-[#f8f8f7] content-stretch flex flex-col gap-[80px] items-center overflow-clip pb-[198px] pt-[80px] px-[592px] relative shrink-0 w-[1920px]" data-name="9_contato">
      <Frame56 />
      <Frame59 />
    </div>
  );
...
function Frame1() {
  return (
    <div className="h-[32px] relative shrink-0 w-[140.13px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 140.13 32">
        <g id="Frame 12">
          <path d={svgPaths.p3ab85c00} fill="var(--fill-0, #D9D9D9)" id="Subtract" />
          <g id="Logo">
            <g id="Luiza Schulman">
              <path d={svgPaths.p1f0dba00} fill="var(--fill-0, #E9E0D7)" />
              <path d={svgPaths.p82fee50} fill="var(--fill-0, #E9E0D7)" />
              <path d={svgPaths.p30571300} fill="var(--fill-0, #E9E0D7)" />
              <path d={svgPaths.pc23b900} fill="var(--fill-0, #E9E0D7)" />
              <path d={svgPaths.p392f8c80} fill="var(--fill-0, #E9E0D7)" />
              <path d={svgPaths.p1d635300} fill="var(--fill-0, #E9E0D7)" />
              <path d={svgPaths.p2177dfc0} fill="var(--fill-0, #E9E0D7)" />
              <path d={svgPaths.p19343280} fill="var(--fill-0, #E9E0D7)" />
              <path d={svgPaths.p1b614500} fill="var(--fill-0, #E9E0D7)" />
              <path d={svgPaths.p879ea80} fill="var(--fill-0, #E9E0D7)" />
              <path d={svgPaths.p3e2c7640} fill="var(--fill-0, #E9E0D7)" />
              <path d={svgPaths.p99da000} fill="var(--fill-0, #E9E0D7)" />
              <path d={svgPaths.p3320000} fill="var(--fill-0, #E9E0D7)" />
            </g>
          </g>
        </g>
      </svg>
...
export default function HomePage() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start pb-[80px] relative size-full" data-name="Home Page">
      <Component2HeroSection />
      <Component3OQueInvestiga />
      <Component4ParaQuemEIndicado />
      <Component5SobreAAvaliacao />
      <Component6QuemVaiTeAtender />
      <Component7TesteGratuito />
      <Component8Faq />
      <Component9Contato />
      <div className="bg-[#1e0c01] gap-x-[40px] gap-y-[295px] grid grid-cols-[repeat(4,minmax(0,1fr))] grid-rows-[repeat(1,fit-content(100%))] h-[345px] p-[64px] relative shrink-0 w-[1920px]" data-name="10_footer">
        <div aria-hidden="true" className="absolute border-[#5c3e2a] border-solid border-t inset-0 pointer-events-none" />
        <Frame71 />
        <Frame69 />
      </div>
      <div className="absolute h-[8172px] inset-0 pointer-events-none">
        <div className="content-stretch flex flex-col items-start overflow-clip pointer-events-auto px-[80px] py-[16px] sticky top-0" data-name="1_navbar">
          <NavContents />
        </div>
      </div>
    </div>
