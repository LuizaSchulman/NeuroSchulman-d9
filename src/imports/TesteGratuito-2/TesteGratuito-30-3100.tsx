import svgPaths from "./svg-m71ags66r9";
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[588.8px]">
      <Frame2 />
    </div>
  );
}
...
function Frame22() {
  return (
    <div className="content-stretch flex gap-[12px] h-[50px] items-start relative shrink-0 w-full">
      <div className="flex-[1_0_0] min-w-px relative rounded-[38px] self-stretch" data-name="Button">
...
function CardTest() {
  return (
    <div className="bg-[#f8f8f7] content-stretch flex flex-col gap-[40px] items-start p-[24px] relative rounded-[6px] shrink-0 w-[1140px]" data-name="card-test">
...
function Contato() {
  return (
    <div className="bg-[#f8f8f7] content-stretch flex flex-col gap-[64px] items-center overflow-clip px-[592px] py-[160px] relative shrink-0 w-[1920px]" data-name="#contato">
      <Frame5 />
      <CardTest />
    </div>
  );
...
export default function TesteGratuito() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Teste Gratuito">
      <Contato />
      <div className="bg-[#1e0c01] h-[345px] relative shrink-0 w-[1920px]" data-name="Footer">
        <div className="gap-x-[40px] gap-y-[295px] grid grid-cols-[repeat(4,minmax(0,1fr))] grid-rows-[repeat(1,fit-content(100%))] overflow-clip p-[64px] relative rounded-[inherit] size-full">
          <Frame10 />
          <Frame8 />
        </div>
