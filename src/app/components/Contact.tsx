            ...
            <div className="p-6 border border-[#39261B] rounded-md flex flex-col justify-between gap-4">
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-[#1E0C01] text-base font-extrabold tracking-tight">
                    Endereço
                  </h3>
                  <div className="text-[#1E0C01] text-base font-medium leading-[1.6] tracking-tight">
                    <p>Urban Office</p>
                    <p>
              ...
              <a
                ...
                className="w-full px-6 py-4 border border-[#1E0C01] text-[#1E0C01] text-base font-bold tracking-tight rounded-full hover:bg-[#1E0C01]/12 transition-colors inline-flex items-center justify-center"
              >
                Ver no Google Maps
              </a>
            </div>
            ...
            <div className="p-6 border border-[#39261B] rounded-md flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="text-[#1E0C01] text-base font-medium leading-[1.6] tracking-tight">
                  ...
                  <br />
                  <p className="font-extrabold">Horário comercial</p>
            ...
            <div className="p-6 border border-[#39261B] rounded-md flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full px-6 py-4 bg-[#1E0C01] text-[#F8F8F7] text-base font-extrabold tracking-tight rounded-full hover:bg-[#5C3E2A] transition-colors duration-300 inline-flex items-center justify-center text-center"
                >
