      ...
      {isMobileMenuOpen && (
        ...
        >
          ...
          >
            ...
            {/* Mobile Menu Links */}
            <div className="flex flex-col flex-1 gap-1 items-start justify-center w-full text-[#1E0C01] text-base font-semibold tracking-tight text-center px-6 pt-10 pb-16 -mt-10">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full px-6 py-4 mt-4 bg-[#0F5789] text-[#F8F8F7] text-base font-extrabold tracking-tight rounded-full hover:bg-[#1D7ABB] transition-colors duration-300 inline-flex items-center justify-center"
                onClick={handleLinkClick}
                style={{
                  opacity: isAnimatingIn ? 1 : 0,
                  transform: isAnimatingIn ? 'translateY(0)' : 'translateY(16px)',
